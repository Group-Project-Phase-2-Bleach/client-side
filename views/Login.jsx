  ...
  return (
    <>
      <div className="relative flex items-center justify-center h-screen bg-gray-900">
        ...
        <div className="relative w-full max-w-md p-8 space-y-6 bg-gray-800 text-white rounded-xl shadow-lg transform transition-transform duration-500 hover:scale-105 hover:shadow-2xl">
          <h1 className="text-2xl font-bold text-white mb-6 text-center">
            Selamat Datang{" "}
            <span className="text-2xl pl-2">
              <i className="em em-grinning" />
              <Link to={"/"} className="font-varino">
                <span className="text-blue-500 text-3xl font-extrabold italic"></span>
              </Link>
            </span>
          </h1>
          <p className="text-gray-300 mb-8 text-center">Silahkan Login</p>
